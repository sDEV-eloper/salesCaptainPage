    ...
    <div className="bg-gray-100 rounded-2xl shadow-md p-4 border border-gray-300 w-full text-center mx-4">
      ...
      <div className="flex flex-col items-center mt-4">
        ...
        <div className="flex flex-col rounded">
          ...
          <div className="flex flex-wrap justify-center items-center p-2 bg-white rounded-2xl">
            {productUsed.map((product, index) => (
              <span key={index} className="bg-gray-700 text-white px-2 py-1 rounded-full text-xs mt-2 mr-2">
                {product}
              </span>
            ))}
          </div>
